...
from .views import StartWorkView, EndWorkView, ReviewView, ObjectStatusView, WorkImageDeleteView, WorkImageDetailView, WorkImageListView, WorkImageUploadView
...
urlpatterns = [
    ...
    path('status_object/<int:object_id>/', ObjectStatusView.as_view(), name='status_object'),
